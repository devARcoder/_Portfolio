  ...
  return (
    <>
     ...
     data-aos-duration="2000" */}
        <div className="static w-60 h-56 bg-black rounded-full border-2 border-gray-400 shadow-inner shadow-white md:absolute md:left-16 md:w-[26rem] md:h-[88vh] md:rounded-2xl md:shadow-xl md:shadow-black md:border-none">
          <img
        ...
        <div
          data-aos="zoom-in-up"
          className="heading flex flex-col items-center space-y-4 my-4 text-center md:space-y-7 md:w-[30rem]"
        >
